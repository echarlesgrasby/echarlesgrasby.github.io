...
exclude_patterns = [u'_build', 'Thumbs.db', '.DS_Store', 'bug_reports']
...
htmlhelp_basename = 'echarlesgrasby_blogdoc'
...
latex_documents = [
    (master_doc, 'echarlesgrasby_blog.tex', u'echarlesgrasby\\_blog Documentation',
     u'Eric Charles Grasby', 'manual'),
]
...
man_pages = [
    (master_doc, 'echarlesgrasby_blog', u'echarlesgrasby_blog Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'echarlesgrasby_blog', u'echarlesgrasby_blog Documentation',
     author, 'echarlesgrasby_blog', 'One line description of project.',
     'Miscellaneous'),
]
